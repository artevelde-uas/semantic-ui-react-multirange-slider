...
doc('./src/readme-lib.md')
    ...
    .pipe(abs({
        base: 'https://github.com/artevelde-uas/semantic-ui-react-multirange-slider',
        images: true,
        imageBase: 'https://raw.githubusercontent.com/artevelde-uas/semantic-ui-react-multirange-slider/master'
    }))
    .pipe(out())
